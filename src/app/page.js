    ...
    <div className="flex flex-col min-h-screen p-40 max-w-[1000px] justify-between items-center gap-50">
      ...
      {!res ? (
        <div className=" text-center font-light">
          ...
          Welcome! This is a simple tool to translate a complicatated
          research project briefs into easy to understand user stories that you
          can implement! Download your project brief as a .docx and insert it
          here for it to be turned into user stories.
        </div>
      ) : (
        <></>
      )}
      ...
      {res == null ? (
        <div className="flex  items-center justify-between gap-5">
          <svg
            ...
            viewBox="0 0 32 32"
            className="w-auto h-40 fill-white"
          >
          ...
          <div className="flex flex-col gap-3">
            <h1 className="font-medium font-2xl">
              Rejoice Designers and PMs!{" "}
            </h1>
